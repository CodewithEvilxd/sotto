# Sotto: Developer Conventions

This document captures how the Sotto codebase is written, documented, and checked. It is the practical companion to [ARCHITECTURE.md](./ARCHITECTURE.md) (what the product is) and [Design.md](./Design.md) (how it looks).
...
- `@description` must be meaningful — no filler such as "implementation for Sotto."
- `@author Nishant Gaurav` and `@license MIT` are required.
