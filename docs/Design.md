...
Settings uses the same white canvas as the rest of the primary application shell. It starts with the compact shared Sotto brand header and a seven-day activity summary, followed by grouped actions.
