...
export default function DataSettingsScreen() {
  ...
  const reset = () =>
    Alert.alert(
      "Reset Sotto?",
      "This deletes all ideas and audio, SQLite preferences, and every versioned provider credential. You will set up Sotto again.",
      [
        { text: "Cancel", style: "cancel" },
        {
          text: "Reset app",
    ...
    >
      ...
      <View style={[styles.card, styles.resetCard]}>
        ...
        <Text style={styles.body}>
          ...
          and every versioned speech and AI credential slot. Sotto returns to
          setup.
        </Text>
        <ActionButton
          destructive
