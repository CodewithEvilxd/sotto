...
export default function SystemPromptSettingsScreen() {
  ...
  return (
    <SettingsSubpage
      supporting="Change how Sotto turns a transcript into an idea report. The report structure and citation rules stay protected."
      title="System prompt"
    >
      <View style={styles.contract}>
        ...
        <View style={styles.contractCopy}>
          ...
          <Text style={styles.contractBody}>
            Sotto always validates the title, summary, gist, evidence, risks,
      ...
      <Text style={styles.note}>
        ...
        when Sotto creates a new report or report revision.
      </Text>
    </SettingsSubpage>
  );
}
